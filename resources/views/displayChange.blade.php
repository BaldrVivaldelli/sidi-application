...
<div id="wrapper">
    ...
    <div id="main">
        <div class="inner">
            ...
            <!-- Form -->
            <h3></h3>
            <form method="post" action="/display/modify">
                {{ csrf_field() }}
                <div class="row gtr-uniform">
                    ...
                    <!-- Break -->
                    <div class="col-12">
                        <select name="display-category" id="display-category">
                            @foreach ($displays as $indexKey => $display) {
                    ...
                    <div class="col-12">
                        <ul class="actions">
                            <li><input type="submit" value="Cambiar" class="primary" /></li>
