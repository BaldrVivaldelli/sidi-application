            ...
            <form method="post" action="/content/update" enctype="multipart/form-data">
                ...
                <div class="row gtr-uniform">
                    <div class="col-7 col-4-xsmall">
                        <input type="text" name="content-name" readonly vaid="content-name" value="{{$regionData['contentNombre'] }}" placeholder="Nombre del contenido" />
                    </div>
                    @if($regionData['estado'] == "habilitado")
