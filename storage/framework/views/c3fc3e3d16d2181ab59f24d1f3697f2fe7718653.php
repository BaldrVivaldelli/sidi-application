            ...
            <form method="post" action="/content/update" enctype="multipart/form-data">
                ...
                <div class="row gtr-uniform">
                    <div class="col-7 col-4-xsmall">
                        <input type="text" name="content-name" readonly vaid="content-name" value="<?php echo e($regionData['contentNombre']); ?>" placeholder="Nombre del contenido" />
                    </div>
                    <?php if($regionData['estado'] == "habilitado"): ?>
                        ...
                        <div class="col-2 col-2-small">
                            <input type="radio" id="habilitada" value="on" name="estado-contenido" checked="checked" />
                            <label for="habilitada">Habilitada</label>
                        </div>
                    <?php else: ?>
                        <div class="col-2 col-2-small">
                            <input type="radio" id="deshabilitada" value="off" name="estado-contenido"checked="checked"  >
                            <label for="deshabilitada">Deshabilitada</label>
                        </div>
                        <div class="col-2 col-2-small">
...
-->
                    ...
                    <div class="col-4 col-12-small">
                        ...
                        <div id="FormatoTres">
                            ...
                            <div id="regionCuatroDetalleCuatroVideo" style="display:none">
                    ...
                    <div class="col-12">
                        ...
                        <ul class="actions">
                            <li><input type="submit" value="Modificar" class="primary" /></li>
            ...
            <?php else: ?>
            <!-- Form -->
            <form method="post" action="/content/selectContent">
                <?php echo e(csrf_field()); ?>

                <div class="col-12">
                    <select name="region-name" id="region-name">
                ...
                <input type="submit" value="Buscar Contenido" class="primary" />
            </form>
