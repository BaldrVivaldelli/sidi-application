...
<script>
    let dataMc;
    fetch('<?php echo e(env('APP_URL')); ?>' +'/api/contenido/getAll/')
        ...
        .then(data =>
            data.contenidos.forEach(contenido => {
                ...
                var url = "<?php echo e(env('APP_URL')); ?> " + contenido;
            ...
            switch (response.type) {
                case "snapshot":
                    ...
                    if(json.archivo_nombre.includes("--CONTIENE DATO TEXTO--")){
                        ...
                        var url = "<?php echo e(config('app.url')); ?>/api/contenido/getById/" + json.archivo_nombre;
                ...
                case "userBlocked":
                    ...
                    var url = "<?php echo e(config('app.url')); ?>/api/contenido/EnableDisableContent";
                    var response = fetch(url)
                        .then(resp => resp.json())
                        .then(json => {
